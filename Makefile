...
pkgincludedir = $(includedir)/flex-bison-cpp-example
...
DIST_COMMON = README $(am__configure_deps) $(srcdir)/Makefile.am \
	...
	ChangeLog INSTALL NEWS scripts/depcomp scripts/install-sh \
	scripts/missing scripts/ylwrap
...
YACC = bison -y
YFLAGS = 
abs_builddir = /media/DATA/Carmine/My Dropbox/CPP/flex-bison-cpp-example-0.1.4
abs_srcdir = /media/DATA/Carmine/My Dropbox/CPP/flex-bison-cpp-example-0.1.4
abs_top_builddir = /media/DATA/Carmine/My Dropbox/CPP/flex-bison-cpp-example-0.1.4
abs_top_srcdir = /media/DATA/Carmine/My Dropbox/CPP/flex-bison-cpp-example-0.1.4
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = $(SHELL) /media/DATA/Carmine/My Dropbox/CPP/flex-bison-cpp-example-0.1.4/scripts/install-sh
