...
#line 115 "parser.yy"
    {
		   ...
		   Piani *p = (yysemantic_stack_[(2) - (1)].piani);
		   ap boh = (yysemantic_stack_[(2) - (2)].ap);
...
#line 159 "parser.yy"
    {
					ap l = (yysemantic_stack_[(2) - (1)].ap);
					l.push_back((yysemantic_stack_[(2) - (2)].Apertura *));
...
#line 614 "parser.cc"
  ...
  Parser::yyrline_[] =
  {
         0,   114,   114,   133,   140,   147,   151,   158,   165,   174
  };
